  ...
  // small stat chart
	...
	elmList.map(function(elm) {
		...
		if (chartType == 'bar') {
			...
			chartColors = ['rgba('+ app.color.themeRgb + ', .95)', 'rgba('+ app.color.themeRgb + ', .35)', 'rgba('+ app.color.themeRgb + ', .55)', 'rgba('+ app.color.themeRgb + ', .75)', 'rgba('+ app.color.themeRgb + ', .95)'];
			chartData = [randomNo(), randomNo()];
			chartStroke = {
				show: false,
				curve: 'smooth',
				lineCap: 'butt',
