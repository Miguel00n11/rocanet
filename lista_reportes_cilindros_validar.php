...
$rutaFirebase = ($tipo === 'Respaldo') ? "Cilindros/Respaldo" : "Cilindros/Reportes";
...
<div id="content" class="app-content">
	<h1 class="page-header">Cilindros pendientes de validar</h1>
	...
	<div class="card">
		<div class="card-body">
			...
			<div class="table-responsive">
				<table id="datatableValidar" class="table text-nowrap w-100">
								...
								<tr>
									...
									<td class="text-center">
										<a href="#"
											...
											onclick="
		window.open('validar_cilindro.php?usuario=<?= urlencode($r['usuario']) ?>&llave=<?= urlencode($r['llave']) ?>&tipo=<?= $tipo === 'Respaldo' ? 'Respaldo' : 'Cilindros' ?>', '_blank');
		return false;
   ">
...
<script>
	document.addEventListener('DOMContentLoaded', function() {
		const tableEl = document.querySelector('#datatableValidar');
